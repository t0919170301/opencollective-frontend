  ...
  return (
    <Flex mx={[3, 4]} my={4} flexDirection="column" alignItems="center" textAlign="center">
      ...
      <Flex
        ...
        width={1}
      >
        <Box width={[null, '448px', null, null, '583px']}>
          <Illustration
        ...
        <Box width={[null, '352px', null, null, '408px']} textAlign="left">
          <Title>
      ...
      >
        ...
        <Box ml={[null, 4, 0]} width={[null, '352px', null, null, '408px']} textAlign="left">
          <Title>
