...
const ScreenshotWrapper = styled(Container)`
  @media screen and (min-width: 64em) {
    background-image: ${props => `url('/static/images/${props.feature}-bg.png')`};
...
const Feature = ({ feature, intl }) => (
  <Container width={1} display="flex" mr={2} flexDirection="column">
    ...
    <ScreenshotWrapper feature={feature}>
      <Box display={['none', null, 'block']} width={[null, null, '609px', null, '735px']}>
        <Illustration
